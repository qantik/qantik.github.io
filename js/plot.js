...
let ctx = document.getElementById("plot-patents-year").getContext('2d');
...
ctx = document.getElementById("plot-patents-months").getContext('2d');
chart = new Chart(ctx, {
    type: 'bar',
    data: {
...
ctx = document.getElementById("plot-citations-indegree").getContext('2d');
chart = new Chart(ctx, {
    type: 'bar',
    data: {
